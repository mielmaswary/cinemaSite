<?php
   ...
   require_once('../utils/echoHtml.php');
    ...
    while ($purchasedTicket=mysqli_fetch_array($result)) {
        ...
        echo '<div class="purchasedThicketInfoContainer">';
...
<form action="./admin.php">
    <input type="text" name="newMovieName" placeholder="שם הסרט"></br>
    <input type="text" name="newMovieDescription" placeholder="תיאור הסרט"></br>
    <input type="number" name="newMovieLength" placeholder="אורך בדקות"></br>
    <input type="text" name="newMovieImgToUpload" placeholder="בחר תמונה"></br>
    <input type="submit">
</form>
...
<h2>עדכון אולם</h2>
<form action="./admin.php">
    <select name="cinemaName" placeholder="שם בית הקולנוע">
    ...
    <input type="number" name="hallNumber" placeholder="מספר האולם" min=1 max=6></br>
    <input type="datetime-local" name="movieDateTime" placeholder=" תאריך ושעה"></br>
    <select name="movieName" placeholder="שם הסרט">
           <?php
    ...
    <input type="number" name="ticketsAvailable" placeholder="מקומות פנויים" min=0></br>
    <input type="submit">
</form>
